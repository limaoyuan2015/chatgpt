package com.szmengran.chatgpt.infrastructure.openai.dto.completion;
...
public class CompletionCreateCmd extends Command {
     ...
     *
     * We generally recommend using this or {@link CompletionCreateCmd#topP} but not both.
     */
    Double temperature;
     ...
     * considered.
     *
     * We generally recommend using this or {@link CompletionCreateCmd#temperature} but not both.
     */
    @JsonProperty("top_p")
    Double topP;
     ...
     * Use carefully and ensure that you have reasonable settings for {@link CompletionCreateCmd#maxTokens} and {@link CompletionCreateCmd#stop}.
     */
    Integer n;
     ...
     *
     * When used with {@link CompletionCreateCmd#n}, best_of controls the number of candidate completions and n specifies how many to return,
